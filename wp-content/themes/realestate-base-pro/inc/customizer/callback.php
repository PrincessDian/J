...
if ( ! function_exists( 'realestate_base_is_author_bio_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function realestate_base_is_author_bio_active( $control ) {
...
if ( ! function_exists( 'realestate_base_is_author_bio_recent_posts_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function realestate_base_is_author_bio_recent_posts_active( $control ) {
...
if ( ! function_exists( 'realestate_base_is_image_in_single_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function realestate_base_is_image_in_single_active( $control ) {
