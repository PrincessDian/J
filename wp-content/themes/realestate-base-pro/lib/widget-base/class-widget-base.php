		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'realestate-base-pro' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'realestate-base-pro' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'realestate-base-pro' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove Button', 'realestate-base-pro' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
